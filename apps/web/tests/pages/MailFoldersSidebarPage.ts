...
/**
 * Page Object — mail-folders-sidebar
 * URL: https://outlook.office.com/mail/inbox
 * Components: SearchBar, ComposeButton, FolderTree, MessageList, CalendarGrid, ContactList
 */
export class MailFoldersSidebarPage {
  constructor(public readonly page: Page) {}

  async goto() {
    await this.page.goto('https://outlook.office.com/mail/inbox');
