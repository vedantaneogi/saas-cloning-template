...
/**
 * Page Object — calendar-new-event
 * URL: https://outlook.office.com/calendar/view/Month
 * Components: SearchBar, CalendarGrid, ContactList, AttendeePicker, CalendarView
 */
export class CalendarNewEventPage {
  constructor(public readonly page: Page) {}

  async goto() {
    await this.page.goto('https://outlook.office.com/calendar/view/Month');
