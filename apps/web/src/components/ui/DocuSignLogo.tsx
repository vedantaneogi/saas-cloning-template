...
function FullLogo({ height, color = '#1B0A3C' }: { height: number; color?: string }) {
  const width = Math.round(height * (1200 / 194));
  return (
    <svg
...
function MarkOnly({ size }: { size: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function DocuSignLogo({ size = 'md', showText = true, className = '' }: DocuSignLogoProps) {
  const h = heights[size];
  if (showText) {
    return <div className={className}><FullLogo height={h} /></div>;
  }
  return <div className={className}><MarkOnly size={h} /></div>;
}

export function DocuSignLogoWhite({ size = 'md', showText = true, className = '' }: DocuSignLogoProps) {
  const h = heights[size];
  if (showText) {
    return <div className={className}><FullLogo height={h} color="#FFFFFF" /></div>;
  }
  return <div className={className}><MarkOnly size={h} /></div>;
}
